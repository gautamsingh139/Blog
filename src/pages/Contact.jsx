    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="space-y-5">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">itsgautamrajput@gmail.com</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">github.com/gautamrajput139</p>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  value={form.email}
                  onChange={handleChange}
                  placeholder="e.g. itsgautamrajput@gmail.com"
                  className="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#0e7db5]/30 focus:border-[#0e7db5] transition"
                />
              </div>
      ...
      <div className="bg-gray-50 border-t py-6 px-6 text-center">
        <p className="text-xs text-gray-400 max-w-2xl mx-auto">
          ⚠️ <strong>Disclaimer:
            </strong> blog is a student learning project built for educational
