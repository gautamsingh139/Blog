...
const terms = [
  {
    ...
    content: `By accessing or using blog ("the Platform"), you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use this website.
...
These terms apply to all visitors, readers, and anyone who interacts with content or features on the platform, including posting comments. We reserve the right to update these terms at any time, and continued use of the platform after any changes constitutes your acceptance.`,
  },
  {
    ...
    content: `blog is a personal blogging platform created for educational and learning purposes. It allows an administrator to publish blog posts that visitors can read and comment on. The platform is a student project and is not intended for commercial use.
...
Features on the platform include reading published blog articles, browsing by category, and submitting comments. All features are provided free of charge and without any guarantee of uptime or availability.`,
  },
  {
    ...
    content: `When using blog, you agree to behave respectfully and lawfully. You must not:
...
Violation of these rules may result in your comments being removed and your access to the platform being restricted.`,
  },
  {
    ...
    content: `By submitting a comment on blog, you grant us a non-exclusive, royalty-free right to display that comment on the platform. You are solely responsible for the content of your submissions.
...
Please do not include personal information such as phone numbers, addresses, or passwords in your comments. blog is not responsible for any information you choose to share publicly.`,
  },
  {
    title: "5. Intellectual Property",
    content: `All blog content published on blog, including text, images, and formatting, is the property of the platform's administrator unless otherwise stated. You may not copy, reproduce, distribute, or publish any content from blog without explicit written permission.

You are welcome to share links to blog posts on social media or other platforms, giving appropriate credit to blog.`,
  },
  {
    title: "6. Disclaimers",
    content: `blog is provided on an "as is" and "as available" basis. We make no warranties, expressed or implied, regarding the accuracy, completeness, or reliability of any content published on the platform.
...
As a student project, the platform may experience downtime, bugs, or incomplete features. We are not responsible for any loss or inconvenience caused by the unavailability of the platform.`,
  },
  {
    ...
    content: `To the fullest extent permitted by law, blog and its developer shall not be liable for any direct, indirect, incidental, or consequential damages arising from your use of the platform, including but not limited to data loss, service interruptions, or reliance on published content.`,
  },
  {
    title: "8. Third-Party Links",
    content: `Blog posts on blog may contain links to external websites. These links are provided for convenience and informational purposes only. blog does not endorse or take responsibility for the content, privacy practices, or terms of any third-party websites.`,
  },
  {
    title: "9. Termination",
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-3xl mx-auto px-6 pt-12 pb-4">
        <div className="bg-amber-50 border border-amber-100 rounded-xl p-5 text-sm text-amber-800 leading-relaxed">
          <strong>Please read these terms carefully.</strong> By using blog, you agree to the
      ...
      <div className="bg-gray-50 border-t py-6 px-6 text-center">
        <p className="text-xs text-gray-400 max-w-2xl mx-auto">
          ⚠️ <strong>Disclaimer:</strong> blog is a student learning project built for educational
