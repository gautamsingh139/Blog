...
const sections = [
  {
    ...
    content: `When you visit blog, we may collect certain information automatically, including your browser type, operating system, referring URLs, and pages visited. This information is collected through standard web server logs and is used solely for improving the website experience.
...
We do not use your information for advertising, profiling, or selling to third parties.`,
  },
  {
    ...
    content: `blog allows users to leave comments on blog posts. All comments are reviewed by an administrator before being publicly displayed. This moderation process helps ensure a respectful and constructive community environment.
...
We reserve the right to reject or delete any comment that is spam, offensive, irrelevant, or violates our community guidelines.`,
  ...
  {
    title: "4. Cookies",
    content: `blog may use basic cookies to improve your browsing experience. Cookies are small text files stored on your device that help the website remember your preferences or session state.

At this time, blog does not use third-party tracking cookies or advertising cookies. If this changes in the future, this policy will be updated accordingly.
...
You can disable cookies through your browser settings, though some features of the website may not function as expected if you do so.`,
  },
  {
    ...
    content: `blog uses a limited set of third-party services to operate the platform, including cloud-based image hosting (Imagekit) and a hosted database service (MongoDB Atlas). These services may process certain data as part of normal operations.
...
Since blog is a student learning project, it may not implement enterprise-level security measures. We strongly recommend that you do not submit sensitive personal information through this platform.`,
  },
  {
    title: "7. Children's Privacy",
    content: `blog is not directed at children under the age of 13. We do not knowingly collect personal information from children. If you believe that a child has submitted personal information to us, please contact us and we will take steps to remove that information.`,
  },
  {
    title: "8. Changes to This Policy",
    content: `We may update this Privacy Policy from time to time as the platform grows or as legal requirements change. Any updates will be posted on this page with a revised effective date. Continued use of blog after changes are posted constitutes your acceptance of the updated policy.`,
  },
  {
    title: "9. Contact",
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-3xl mx-auto px-6 pt-12 pb-4">
        <div className="bg-blue-50 border border-blue-100 rounded-xl p-5 text-sm text-blue-800 leading-relaxed">
          ...
          blog collects, how it is used, and your rights regarding that information. Please read
